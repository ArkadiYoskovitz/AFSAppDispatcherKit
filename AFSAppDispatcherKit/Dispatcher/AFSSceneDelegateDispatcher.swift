//
//  AFSSceneDelegateDispatcher.swift
//  AFSAppDispatcherKit
//
...
open class AFSSceneDelegateDispatcher : UIResponder {
    ...
    ///
    open func obtainServices() -> [AFSSceneDelegateService] {
        
        return []
    }
    
    fileprivate lazy var sceneServices : [AFSSceneDelegateService] = {
...
/// ================================================================================================================ ///
@available(iOS 13.0, *)
extension AFSSceneDelegateDispatcher : UISceneDelegate {
