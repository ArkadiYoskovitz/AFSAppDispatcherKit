//
//  AFSWindowSceneDelegateDispatcher.swift
//  AFSAppDispatcherKit
//
...
import UIKit
import CloudKit
import ObjcExtensions
/// ================================================================================================================ ///
///
/// ================================================================================================================ ///
@available(iOS 13.0, *)
open class AFSWindowSceneDelegateDispatcher : AFSSceneDelegateDispatcher {
    ...
    ///
    public var monitoredWindowSceneServices : [AFSWindowSceneDelegateService] {
    ...
    ///
    open func obtainWindowSceneServices() -> [AFSWindowSceneDelegateService] {
        
        return []
    }
    
    fileprivate lazy var windowSceneServices : [AFSWindowSceneDelegateService] = {
...
/// ================================================================================================================ ///
@available(iOS 13.0, *)
extension AFSWindowSceneDelegateDispatcher : UIWindowSceneDelegate {
